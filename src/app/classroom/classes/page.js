...
const Classes = () => {
  return (
    <main className="w-[calc(100%-240px)] h-[100vh] float-right flex">
      <div className="mt-[40px] pl-[50px] flex flex-col gap-[40px]">
        <ClassroomNavBar />
        <div className="flex w-fit flex-col mt-[65px] gap-[12px]">
          ...
          <div className="bg-white rounded-[16px] md:p-[15px] lg:p-[24px] flex md:w-[60%] lg:w-[576px] justify-between">
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <div className="flex gap-[10px]">
                <Link
                  className="text-Vivid_Tangelo underline font-bold"
