...
const FreeLecture = () => {
  ...
  return (
    <>
          ...
          <div className="sm:mx-auto  xl:mx-0 ">
            <div className="flex items-start flex-col gap-y-[30px] ">
              ...
              <div className="text-center sm:w-[300px] md:w-[389px] md:text-[18px]">
                ...
                <p className="text-Vivid_Tangelo font-semibold">
            ...
            <button
              onClick={handleModal}
              className={`uppercase bg-Vivid_Tangelo sm:mx-auto mb-[24px] mt-[36px] flex ml-[30px] justify-center sm:w-[230px] md:w-[297px] h-[44px] p-[10px] gap-x-[10px] rounded-lg items-center text-[10px] font-semibold text-white`}
            >
              <Image
                width={24}
                height={24}
      ...
      <div className="flex w-full px-[15px] font-bold md:justify-center bg-Vivid_Tangelo sm:justify-around sm:text-[12px] md:text-[16px] text-white items-center py-[4px] gap-x-[34px]">
        <p>Have Questions? Reach out at 9892201029</p>
        <Link
          href="/preAuth/requestCallBack"
          className="text-Vivid_Tangelo sm:text-center md:text-start cursor-pointer bg-white rounded-[8px] sm:p-[5px] md:p-[10px]"
        >
          Request Callback
        </Link>
      </div>
