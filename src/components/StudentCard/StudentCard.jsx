...
const StudentCard = (props) => {
  ...
  return (
    ...
    >
      <div className="bg-lightGreen flex w-fit gap-[9.5px] absolute right-0 text-[11px] font-bold p-[7.52px] rounded-l-[7.52px]">
      ...
      <p className="text-center text-xl text-Vivid_Tangelo font-semibold">{role}</p>
      <div
      ...
      <p
        className={`md:mt-6 sm:mt-4 text-center text-lg font-bold text-Vivid_Tangelo ${styles.package}`}
      >
        Package : &#x20B9; {ctc}
      </p>
    </div>
