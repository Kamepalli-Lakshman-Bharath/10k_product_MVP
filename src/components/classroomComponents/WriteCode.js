      ...
      <div className="flex flex-col gap-[30px]">
        <div className="h-[400px] bg-white w-[40rem] overflow-hidden rounded-[16px]">
          <textarea
            name=""
            id=""
            className="bg-bone rounded-[16px] p-[10px] resize-none w-[90%] mt-[30px] mx-auto block focus:outline-none "
            cols="30"
            rows="10"
          ></textarea>
          <div className="flex mt-[20px] mx-[30px] justify-between">
            <p className="font-bold text-stoneGray">Hint</p>
            <button className="font-bold rounded-[16px] p-[10px] text-white bg-Vivid_Tangelo">
              submit
            </button>
          </div>
        </div>
        <div className="h-[130px] p-[20px] flex flex-col gap-[10px] bg-white rounded-[16px]">
          <p className="text-Vivid_Tangelo font-bold">Output</p>
          <p>
