...
const StudentProgressCard = () => {
  ...
  return (
    <main className="h-[21.4rem] w-[270px] rounded-[16px] flex flex-col py-[20px] gap-[20px]  bg-white mx-auto">
      <p className="font-bold text-center">Week 1 Progress</p>
      <div
        style={circleStyle}
        className="h-[140px] w-[140px] rounded-full flex items-center justify-center mx-auto relative "
      >
