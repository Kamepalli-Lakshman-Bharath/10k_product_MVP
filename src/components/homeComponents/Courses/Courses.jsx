...
export default function Courses({ curriculum }) {
  ...
  const renderModule = (moduleNum, title, duration) => (
    <div
      ...
      } cursor-pointer rounded-2xl hover:bg-bone sm:m-2 sm:w-[250px] sm:flex-shrink-0 sm:p-2 md:m-0 md:w-[293px] md:px-[20px] md:py-[10px] lg:py-[20px] xl:px-[30px]`}
    >
      <div className="flex justify-between">
        <p className="text-[10px] font-bold lg:mb-[10px]">
          Module {moduleNum + 1}
        </p>
        <p className={`text-[10px] sm:block md:hidden`}>{duration}</p>{" "}
      </div>
      <div className="flex items-center justify-between gap-x-10 font-bold ">
        ...
        <p className={`text-[10px] sm:hidden md:block`}>{duration}</p>{" "}
      </div>
    </div>
  );
  return (
    <>
      ...
      <section className={` ${styles.section} w-full flex`}>
        <div className="flex-shrink-0  sm:w-[10%] items-center gap-[10px] justify-center md:w-[10%] flex flex-col ">
          <img
            ...
            alt=""
          />
          <div className={`w-[3px]  bg-Vivid_Tangelo h-full`}></div>
        </div>
        <div className="sm:w-[90%] pb-20">
          <p className="text-Vivid_Tangelo ml-[25px] md:text-start md:text-[32px] sm:text-center sm:text-[24px] lg:text-[48px] font-semibold tracking-[4.8px] uppercase leading-[normal]">
            curriculum
          </p>
            ...
            >
              ...
              >
                ...
                <div className="bg-white sm:p-3 md:p-4 xl:h-[417px]">
                  ...
                  <p className=" text-darkGray  sm:my-1 sm:text-[14px] md:text-[15px] lg:text-[16px] ">
                    Full-stack Front-end Developer
                  </p>
                  <p className="font-bold sm:my-1 sm:text-[16px] md:text-[18px] lg:text-[20px]">
                    What You Will Learn
                  </p>
                  <p className="leading-6  text-darkGray sm:mb-[30px] sm:text-[14px] md:text-[15px] lg:text-[16px]">
                  ...
                  <button
                    className={`mx-auto block cursor-pointer font-bold text-Vivid_Tangelo sm:text-[16px] md:text-[18px] lg:text-[20px]`}
                  >
                    Enroll Now
                  </button>
                </div>
              ...
              >
                <p className="pb-1 text-xl text-darkGray">Duration : 8 weeks</p>
      ...
      <section className="flex">
        ...
        <div className="w-[90%]  m ">
          <p className="text-Vivid_Tangelo  ml-[25px] md:text-start md:text-[32px] sm:text-center sm:text-[24px] lg:text-[48px] font-semibold tracking-[4.8px] sm:my-4 md:my-2 uppercase leading-[normal]">
            journey
          </p>{" "}
          <div className=" ">
            <img
