  ...
  return (
    <>
      <section className="flex items-center gap-[24px]  flex-col font-bold">
        <div className="flex w-full px-[15px] md:justify-center bg-Vivid_Tangelo sm:justify-around sm:text-[12px] md:text-[16px] text-white items-center py-[4px] gap-x-[34px]">
          <p>Have Questions? Reach out at 9892201029</p>
          <Link
            href="/preAuth/requestCallBack"
            className="text-Vivid_Tangelo sm:text-center md:text-start cursor-pointer bg-white rounded-[8px] sm:-[5px] md:p-[10px]"
          >
            Request Callback
          </Link>
        </div>
        ...
        >
          <span className="text-Vivid_Tangelo">100+</span> Companies have hired
          from <br /> 10000 Coders
        </p>
      </section>
