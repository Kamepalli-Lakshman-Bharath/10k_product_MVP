              ...
              >
                ...
                {!allowUpload ? (
                  <div className="flex flex-col gap-[20px]">
                    ...
                    <button
                      onClick={handleAllowUpload}
                      className="font-bold focus:outline-none rounded-[16px] mx-auto text-white w-fit py-[16px] bg-Vivid_Tangelo px-[24.5px] cursor-pointer"
                    >
                      Upload Files
                    </button>
                  </div>
                  ...
                  <div className="pl-[50px] mt-[20px] flex flex-col gap-[16px]">
                    <label className="flex flex-col gap-[8px]">
                      Upload Hosted Link:
                      <div className="px-[10px] py-[5px] flex focus-within:border-Vivid_Tangelo rounded-[8px] border border-boulder w-[367px] overflow-hidden focus-within:border">
                        <input
                          type="text"
                    ...
                    <button className="font-bold focus:outline-none rounded-[16px] text-white w-fit py-[10px] bg-Vivid_Tangelo px-[24.5px] cursor-pointer">
                      Submit
                    </button>
                  </div>
                )}
