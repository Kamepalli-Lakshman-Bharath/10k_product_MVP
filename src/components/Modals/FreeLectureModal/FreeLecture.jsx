      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-full overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className={` relative transform overflow-hidden w-[80%] h-[650px] rounded-lg bg-aliceblue text-left items-center justify-center transition-all sm:my-8 flex gap-[16px] `}
              >
                ...
                <div className=" w-[560px] flex flex-col gap-[16px] overflow-hidden rounded-[12px">
                  ...
                  <Link
                    ...
                    className="bg-Vivid_Tangelo text-white text-[16px] py-[8px] px-[30px] rounded-md w-fit mx-auto font-bold text-center"
                  >
                    Register
                  </Link>
                </div>
